...
class DoramasAssistidosPage extends StatefulWidget {
  @override
  _DoramasAssistidosPageState createState() => _DoramasAssistidosPageState();
}

class _DoramasAssistidosPageState extends State<DoramasAssistidosPage> {
  List<String> doramas = [];
