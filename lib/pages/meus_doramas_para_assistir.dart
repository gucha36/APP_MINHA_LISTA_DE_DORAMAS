...
class MeusDoramasParaAssistir extends StatefulWidget {
  @override
  _MeusDoramasParaAssistirState createState() =>
      _MeusDoramasParaAssistirState();
}

class _MeusDoramasParaAssistirState extends State<MeusDoramasParaAssistir> {
  List<String> doramas = [];
